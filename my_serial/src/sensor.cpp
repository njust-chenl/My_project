...
void my_odom::Para_Init() {
 // n.param<double>("odom_fac", ODOM_FAC, 12);
  ...
  n.param<double>("robot_control/Wheel_Diameter", Wheel_Diameter, 0.147);
  n.param<double>("robot_control/Wheel_Track", Wheel_Track, 0.51);
  ...
  ODOM_FAC = (PI * Wheel_Diameter) / (Reduction_Ratio * Encoder_Accuracy);//转一圈的脉冲对应的圆周长度
